...
INT32 sctp_recvmsg(INT32 s, VOID *msg, size_t len, sock_addr_t *from, socklen_t *fromlen,
		struct sctp_sndrcvinfo *sinfo, INT32 *msg_flags) {
	INT32 error;
	struct iovec iov;
	struct msghdr inmsg;
